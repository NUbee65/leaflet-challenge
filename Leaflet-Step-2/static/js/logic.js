/////////////////////////////////////////////////////////
// USGS GEOJSON URL (PAST 7 DAYS EARTHQUAKES) AND TECTONIC PLATE BOUNDARY URL
/////////////////////////////////////////////////////////
var quakesUrl = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";
var platesUrl = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"

// USGS tectonic plates URL that returns JSON data but failed to work with my code
// It's kind of funky.  It's in a format called pjson.  And it's designed to work with ArcGIS.
// But it's supposed to be fully GeoJSON ready.  The documentation was very difficult to fathom.
// var platesUrl = "https://earthquake.usgs.gov/arcgis/rest/services/eq/map_plateboundaries/MapServer/1?f=pjson"


/////////////////////////////////////////////////////////
// CREATE PLACEHOLDER OVERLAYS LAYER GROUPS
/////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////
// MAPBOX BASE / TILE LAYERS => BASEMAPS OBJECT
/////////////////////////////////////////////////////////
...
// Create overlays layer group 
// var earthquakesLayer = new L.layerGroup();
// var tectonicplatesLayer = new L.layerGroup();

// Create an Object of overlays /// , always visible  ??????
var overlayMaps = {  
...
var myMap = L.map("map", {
  ...
  zoom: 5,
  layers: [streetmap, earthquakesLayer]  // , earthquakes  ????  , overlayGroup[1]
});
